...
class Application:
    def __init__(self, output_path = "./"):
        ...
        label.config(font=("BankGothic LT BT", 40))
        label.pack()
    ...
    def take_snapshot(self):
        ...
        frame = cam.read()[1]
        cv2.imwrite(filename='C:/101-classification/examples/img.jpg', img=frame)
        os.system("check.bat")
        #self.video_loop()
    ...
    def browsecsv(self):
        ...
        #os.remove("C:/101-classification/examples/img.jpg")
        shutil.copy(fileName,"C:/101-classification/examples/")
        #path="C:/101-classification/"
        os.chdir("C:/101-classification/")
        #fileName.save("{}").format(fileName)
        #os.rename(fileName, "img.jpg")
        #os.system("check.bat")
        os.system("python classify.py -m fashion.model -l mlb.pickle -i"+'"'+fileName+'"')
